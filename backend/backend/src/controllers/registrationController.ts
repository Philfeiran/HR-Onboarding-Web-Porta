...
export class RegistrationController{
    ...
    async createRegistration(req:Request,res:Response,next:NextFunction): Promise<void>{
        try{
            ...
            const result = await this.registrationModel.createRegistration(name,email);
            console.log(result);
            res.status(200);
